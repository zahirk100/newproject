...
export async function POST(
  ...
  const tekst =
    actie === "akkoord"
      ? `${bijgewerkt.klantnaam || "De klant"} is akkoord met de voorgestelde afspraak. Bekijk het in je planning.`
      : `${bijgewerkt.klantnaam || "De klant"} stelt een andere datum voor. Bekijk en reageer in je planning.`;
